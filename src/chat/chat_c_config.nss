...
// treated as a command. Do not use "-", "=", ":", any characters in GROUPS
// below, or any normal alphanumeric characters.
...
// DESIGNATORS above, or any normal alphanumeric characters.
const string GROUPS = "``{}[]()<>";
