...
const float DKSN_HTF_AREATRAVELCOST_DELAY = 5.0;
...
const int DKSN_HTF_USE_CUSTOM_DECREMENT_FACTORS = TRUE;
...
const int DKSN_HTF_APPLY_TO_ASSOCIATES = TRUE;
...
const int DKSN_HTF_APPLY_TO_ANIMALCOMPANION = TRUE;
const int DKSN_HTF_APPLY_TO_FAMILIAR = TRUE;
const int DKSN_HTF_APPLY_TO_HENCHMAN = TRUE;
const int DKSN_HTF_APPLY_TO_SUMMONS = FALSE;
const int DKSN_HTF_APPLY_TO_DOMINATED = FALSE;
const int DKSN_HTF_APPLY_TO_PALADINMOUNT = TRUE;

//  This script will be run for any associate if their switch above is set to TRUE.
const string DKSN_HTF_ASSOCIATE_SCRIPT = "ds_htf_assoc_add";

//If DKSN_HTF_APPLY_HTF_TO_ASSOCIATES is TRUE, we need to configure how the system
...
//  (H ||||| T ||| F ||).  Set DKSN_HTF_ASSOCIATE_DISPLAY_TYPE to the appropriate
//  value.
const int ASSOCIATE_DISPLAY_LETTERS = 1;
const int ASSOCIATE_DISPLAY_NUMBERS = 2;
const int ASSOCIATE_DISPLAY_BARS = 3;

const int DKSN_HTF_ASSOCIATE_DISPLAY_TYPE = ASSOCIATE_DISPLAY_NUMBERS;
...
//Values <= DKSN_HTF_THRESHHOLD_DIRE will be displayed in Red text.
//Values > DKSN_HTF_THRESHHOLD_DIRE and <= DKSN_HTF_THRESHHOLD_CAUTION will be displayed in Yellow text.
//Values > DKSN_HTF_THRESHHOLD_CAUTION will be displayed in Green text.
const int DKSN_HTF_THRESHHOLD_OK = 100;
const int DKSN_HTF_THRESHHOLD_CAUTION = 50;
const int DKSN_HTF_THRESHHOLD_DIRE = 10;
