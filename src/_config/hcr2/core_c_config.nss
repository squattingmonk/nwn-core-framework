...
const string INSTALLED_LIBRARIES = "pqj_l_plugin,dlg_l_plugin,pw_l_plugin,bleed_l_plugin,corpse_l_plugin,deity_l_plugin,fugue_l_plugin,htf_l_plugin,loot_l_plugin,rest_l_plugin,torch_l_plugin,unid_l_plugin";
...
const string INSTALLED_PLUGINS = "bw_defaultevents,pqj,dlg,pw,pw_bleed,pw_corpse,pw_deity,pw_fugue,pw_htf,pw_loot,pw_rest,pw_torch,pw_unid";
